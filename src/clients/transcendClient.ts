...
export class TranscendClient {
  private static vendor: string = Vendor.Transcend;
  private static baseUrl: string = BaseUrl.Transcend;
  private static products: Array<IProduct> = new Array<IProduct>();
  private static factory: TranscendScraper = new TranscendScraper();
  private static config: IConfig = config;

  public static async run(): Promise<void> {
    const shopifyApi = new ApiService(VendorApiUrl.Transcend);
