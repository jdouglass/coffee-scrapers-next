...
export class SamJamesClient {
  private static vendor: string = Vendor.SamJames;
  private static baseUrl: string = BaseUrl.SamJames;
  private static products: Array<IProduct> = new Array<IProduct>();
  private static factory: SamJamesScraper = new SamJamesScraper();
  private static config: IConfig = config;

  public static async run(): Promise<void> {
    const shopifyApi = new ApiService(VendorApiUrl.SamJames);
