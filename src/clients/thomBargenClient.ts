...
export class ThomBargenClient {
  private static vendor: string = Vendor.ThomBargen;
  private static baseUrl: string = BaseUrl.ThomBargen;
  private static products: Array<IProduct> = new Array<IProduct>();
  private static factory: ThomBargenScraper = new ThomBargenScraper();
  private static config: IConfig = config;

  public static async run(): Promise<void> {
    const shopifyApi = new ApiService(VendorApiUrl.ThomBargen);
